    ...
    public class Course : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CourseE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CourseE", typeof(IIS.StudentRegistration.Course));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CourseL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CourseL", typeof(IIS.StudentRegistration.Course));
                }
            }
        }
    }
