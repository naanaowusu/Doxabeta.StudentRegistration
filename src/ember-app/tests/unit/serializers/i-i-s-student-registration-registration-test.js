...
moduleForModel('i-i-s-student-registration-registration', 'Unit | Serializer | i-i-s-student-registration-registration', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-student-registration-registration',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
